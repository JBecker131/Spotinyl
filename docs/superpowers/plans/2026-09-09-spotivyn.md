...
**Spec:** `docs/superpowers/specs/2026-09-09-spotivyn-design.md`
...
<html lang="en">
  ...
  <body>
    <div class="deck" data-status="needs-setup">
      <div class="plate">
        <div class="badge">
          <span class="badge__mark">SPOTIVYN</span>
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Spotivyn — state preview</title>
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Spotivyn setup</title>
    <link rel="stylesheet" href="options.css" />
  </head>
  <body>
    <main class="page">
      <h1>Spotivyn setup</h1>
      <p class="lede">
        Spotivyn talks to Spotify with your own developer credentials. This is a
      ...
      <ol class="steps">
        ...
        <li>
          ...
          <p>On your new app's settings page, copy the <strong>Client ID</strong> and paste it here. Leave the Client Secret alone — Spotivyn uses PKCE and never needs it.</p>
          <div class="copy-row">
        ...
        <li>
          <h2>Connect</h2>
          <p>Authorize Spotivyn to read and control your playback.</p>
          <div class="actions">
...
Expected: Spotivyn appears with the vinyl record icon and **no errors** listed on its card. If the card shows an error, open it, fix the reported file, and reload.

- [ ] **Step 3: Verify the pre-setup state**

Click the Spotivyn toolbar icon.
Expected: the turntable renders, the record shows a blank white label, the overlay reads "Spotivyn needs your Spotify Client ID", the transport keys are dimmed, and the lamp is dark.
...
Check the service worker console (`chrome://extensions` → Spotivyn → **service worker**) for errors. Expected: none.
